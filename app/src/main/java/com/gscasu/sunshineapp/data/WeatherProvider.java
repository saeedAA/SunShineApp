package com.gscasu.sunshineapp.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    private static final String sLocationAndDateSelection =
            WeatherContract.LocationEntry.TABLE_NAME +
                    "." + WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ? AND " +
                    WeatherContract.WeatherEntry.COLUMN_DATETEXT + " = ? ";
    ...
    private Cursor getWeatherByLocationAndDate(Uri uri, String[] projection, String sortOrder){
        ...
        String selection = sLocationAndDateSelection;
        ...
        switch (match) {
            case WEATHER:{
                ...
                if (_id > 0)
                    ...
                    throw new android.database.SQLException("Couldn't insert into: " + uri);
                break;
            }
            case LOCATION:{
                long _id = mOpenHelper.getWritableDatabase().insert(
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case WEATHER:
                affected = mOpenHelper.getWritableDatabase().delete(
                        WeatherContract.WeatherEntry.TABLE_NAME,
                        selection,
                        selectionArgs
                );
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case WEATHER:
                affected = mOpenHelper.getWritableDatabase().update(
                        WeatherContract.WeatherEntry.TABLE_NAME,
                        contentValues,
                        selection,
                        selectionArgs
